...
const STUDIES = [
  {
    ...
    lede: "Adolescent ADHD adherence quadrupled when Mendi was provided as part of a 20-session protocol with weekly EEGBase clinic supervision.",
    outcome: "+67%",
  ...
  },
  {
    ...
    lede: "Right-DLPFC down-train protocol delivered via EEGBase clinical supervision with patients running Mendi headsets at home between sessions.",
    outcome: "−7.2",
  ...
  },
  {
    ...
    lede: "Peak-alpha-frequency shift in athletes and creative professionals; cross-session pattern detector linked sleep efficiency to gains.",
    outcome: "+1.4 Hz",
    sub: "Peak alpha · n=56",
    color: "#06B6D4",
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FAFAFA", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      <footer style={{ borderTop: "1px solid #E5E7EB", padding: "24px", textAlign: "center", fontSize: 12, color: "#9CA3AF" }}>
        © 2026 EEGBase · MIT licensed · <Link href="/" style={{ color: "#9CA3AF" }}>Home</Link> · <Link href="/research" style={{ color: "#9CA3AF" }}>Research</Link>
      </footer>
    </div>
  );
}
