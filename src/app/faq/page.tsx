    ...
    <div style={{ minHeight: "100vh", background: "#FAFAFA", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      <main id="main-content" style={{ maxWidth: 760, margin: "0 auto", padding: "48px 24px" }}>
        ...
        <p style={{ fontSize: 15, color: "#64748B", lineHeight: 1.7, marginBottom: 36 }}>
          The questions we get most often, across setup, security, devices, migration, and clinical use. Don't see yours? <Link href="/contact" style={{ color: "#2563EB" }}>Get in touch</Link> — we respond within 24 hours.
        </p>
