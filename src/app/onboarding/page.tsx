...
const DEVICES = [
  {
    ...
    name: "Muse EEG",
    icon: Brain,
    description: "5-channel EEG headband. Measures delta, theta, alpha, beta, and gamma brainwaves via Bluetooth.",
    badge: "EEG",
  ...
  },
  {
    ...
    name: "Mendi fNIRS",
    icon: Activity,
    description: "Functional near-infrared spectroscopy. Measures prefrontal oxygenation (HbO₂) in real time.",
    badge: "fNIRS",
