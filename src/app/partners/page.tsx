...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      { name: "Coalfire",      desc: "SOC 2 audit · scoping in progress · target Q3 2026", status: "planned", color: "#16A34A" },
      { name: "Deque",         desc: "WCAG 2.2 AA accessibility audit · target Q3 2026",   status: "planned", color: "#7C3AED" },
    ],
  },
  {
