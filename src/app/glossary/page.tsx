...
const TERMS = [
  ...
  { term: "SOC 2",           short: "Audit framework for software security + availability.",
    long: "Service Organization Control 2 Type II report. Audited by independent CPA firm. EEGBase: Coalfire Q1 2026, NDA-gated download. See /security." },
  ...
  { term: "VPAT",            short: "Voluntary Product Accessibility Template — accessibility conformance doc.",
    long: "Standard template per Section 508 for documenting WCAG conformance. EEGBase VPAT 2.4: WCAG 2.2 AA Q1 2026, Deque-audited." },
  { term: "WCAG",            short: "Web Content Accessibility Guidelines.",
    long: "International accessibility standard from W3C. EEGBase: 2.2 AA conformant Q1 2026, audited by Deque Systems. See /security for the VPAT." },
