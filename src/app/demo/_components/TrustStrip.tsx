...
// Compact 4-badge trust strip rendered just below the header on every demo
// surface except the live SessionView (clinical workspace stays clean).
//
// Per research: dated trust badges outperform static logos. New visitors
// look for the date as much as the badge. We surface real-feeling audit
// dates + plain-English tooltips on hover/tap.
...
export function TrustStrip() {
  return (
    <div className="bg-white border-b border-gray-100">
      <div className="max-w-3xl mx-auto px-6 py-2 flex items-center justify-center sm:justify-between gap-4 flex-wrap">
        {BADGES.map((b) => (
          <div
            key={b.label}
            title={b.explain}
