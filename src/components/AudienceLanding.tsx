      ...
      <main>
        ...
        <section style={{ maxWidth: 1100, margin: "0 auto", padding: "48px 24px 64px" }}>
          <div style={{ background: c.eyebrowColor, borderRadius: 16, padding: 32, textAlign: "center" }}>
            ...
            <p style={{ fontSize: 14, color: "rgba(255,255,255,0.85)", marginBottom: 20, maxWidth: 540, margin: "0 auto 20px" }}>It&rsquo;s free · no card · synthetic data in the demo · free.</p>
