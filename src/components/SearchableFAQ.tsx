...
const FAQS: Faq[] = [
  ...
  { cat: "Data & security", q: "How does my data flow if I use Mendi at home and my clinician uses EEGBase (especially in the EU)?", a: "Honest answer: this is the part we're being most careful about. Mendi (the device maker) and EEGBase (the clinical platform) are joint controllers under GDPR Art. 26 — meaning we both have responsibilities for your data. Before any EU at-home Mendi user enters a clinical EEGBase view, we'll have (a) a Joint Controller Agreement signed with Mendi, (b) a Data Protection Impact Assessment on file, and (c) GDPR Art. 9 explicit, purpose-specific consent in the Mendi app — not a single tap, but a real choice for each clinician you grant access to. EU clinic data lives in Frankfurt (eu-west-3). Right-to-erasure requests are reconciled against clinical retention rules per country (typically 10–30 years) with a documented policy. None of this is live yet — it gates our EU onboarding and the Coaching marketplace, both planned for Q4 2026." },
