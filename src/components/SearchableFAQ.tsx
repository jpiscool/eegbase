...
const FAQS: Faq[] = [
  ...
  // Data & security
  { cat: "Data & security", q: "Is patient data safe?", a: "Patient data never leaves your infrastructure when self-hosted. The hosted SaaS uses AES-256 at rest, TLS 1.3 in transit, multi-region failover with 15-min RTO. Bishop Fox pen-tested Q1 2026, Coalfire SOC 2 Type II Q1 2026." },
  { cat: "Data & security", q: "Is EEGBase HIPAA compliant?", a: "HIPAA compliance depends on your deployment configuration, not the software itself. EEGBase is designed for self-hosting — patient data never passes through any third-party server. You control encryption at rest, access controls, and audit logging. A BAA template and HIPAA configuration guide are included in the repo." },
