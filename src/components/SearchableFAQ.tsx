...
const FAQS: Faq[] = [
  ...
  { cat: "Data & security", q: "Is client data safe and HIPAA compliant?", a: "Yes. Encrypted in transit (TLS 1.3) and at rest (AES-256-GCM via AWS KMS). HIPAA-friendly architecture; we sign a BAA on enrollment. Bishop Fox penetration test and Coalfire SOC 2 Type II audit are scheduled for Q3 2026. Hosted on U.S. East (EU clinics on Frankfurt eu-west-3)." },
