...
const FAQS: Faq[] = [
  ...
  { cat: "Devices", q: "Does EEGBase work with devices other than Mendi?", a: "Yes. Muse, Polar, Apple Watch, Oura, Whoop, and OpenBCI all work today. Mendi works once they share their pairing details — adapter is built. Adding a new device is a small piece of code." },
  { cat: "Data & security", q: "Is client data safe and HIPAA compliant?", a: "Yes. Encrypted in transit (TLS 1.3) and at rest (AES-256-GCM via AWS KMS). HIPAA-friendly architecture; we sign a BAA on enrollment. SOC 2 Type I scope is being finalised with Coalfire (Type II to follow); a Bishop Fox web pentest is being scoped — both targeted to start Q3 2026. Hosted on U.S. East (EU clinics on Frankfurt eu-west-3)." },
