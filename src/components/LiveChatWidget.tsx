...
const QUICK = [
  ...
  { label: "Is it HIPAA compliant?",   answer: "Yes. Encrypted (TLS 1.3 + AES-256-GCM), HIPAA-friendly architecture, BAA signed on enrollment. SOC 2 audit + independent pen-test planned for Q3 2026 (vendor selection in progress). EU clinics covered by EU privacy law (Schrems II). Full details at /security." },
