...
const QUICK = [
  ...
  { label: "Pricing?",                 answer: "Solo $19/session. Practice $349/month per clinic. Enterprise: custom. 30-day free trial, no card. Mendi clinics get 20% off Practice and Enterprise." },
