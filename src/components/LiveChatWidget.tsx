...
const QUICK = [
  ...
  { label: "Does it work with Mendi?", answer: "Yes — Mendi is our flagship integration. 25 Hz prefrontal fNIRS, sub-80ms latency, 96.4% MAR accuracy, BLE auto-reconnect under 1.4s. See the Devices & API tab in the demo (/demo?tab=devices)." },
